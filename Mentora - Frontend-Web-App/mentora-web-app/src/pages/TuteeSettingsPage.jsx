...
const TuteeSettingsPage = () => {
  ...
  //load current user from my localstorge then api
  useEffect(() => {
    const load = async () => {
      try {
        setPageError("");
  ...
  const goCancelledSessions = () => {
    navigate("/tutee/cancelled-sessions");
  };
  ...
  const logout = () => {
    ...
    navigate("/tutee/login", { replace: true });
  };
...
export default TuteeSettingsPage;